...
\subsection{Variabili casuali (Osservabili), statistiche: distribuzioni di probabilit\'a.}\linkdest{pdfs}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth,keepaspectratio]{RVfunc}
    \label{fig:RVfunc}
\end{figure}
\begin{align*}
...
\subsection{Propagazione errori vs cambio variabili}\linkdest{errors}
...
\subsection{Legge grandi numeri}\linkdest{LLN}
...
\subsection{Important pdf oltre gaussiana}\linkdest{pdfs}

\begin{frame}{Combinationi e permutazioni}
$n!$: permutazioni - modi distinti di prendere n oggetti
\end{frame}

\begin{frame}{Bernoulli, binomiale e Poisson}
