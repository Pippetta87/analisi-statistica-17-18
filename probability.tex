...
$\phi_{\overline{X}_n}(t)=[\phi_X(t)]^n=[1+i\frac{t}{n}\mu+\ldots]^n\to\exp{i\mu t}$; Levy theorem: $\overline{X}_n\to\mu$.
...
\begin{frame}{LLN: asintoticamente gaussiana - Teorema limite centrale (CLT)}\linkdest{clt}
