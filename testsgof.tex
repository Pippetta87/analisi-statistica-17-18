...
\begin{frame}{Bayesian Adaptive psychometric function}
    \begin{itemize}
        ...
        \item computing posterior: Likelihood of sequence on n trials
            \begin{align*}
                ...
                &Q_n(T)=\ln{f_T}+\sum_i^{n-1}\ln{P_{r_i|T}{x_i}}+array\begin{array}{l}
...
\begin{frame}{Test di Mann-Whitney}
    ...
    \end{itemize}
    \begin{align*}
        &U=\sum_i^n\sum_j^mS(X_i,Y_j),\ S(X,Y)=\left\{array\begin{array}{l}
