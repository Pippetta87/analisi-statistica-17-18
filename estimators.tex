...
\begin{frame}{Gaussiana: media ignota, varianza nota}
	...
	&\frac{f(\vec{x}|\theta)}{q(T(\vec{x}|\theta))}=\frac{(2\pi\sigma^2)^{-\frac{n}{2}}\Exp{[-\frac{\sum_i^n(x_1-\exv{x})^2+n(\exv{x}-\mu)^2}{2\sigma^2}]}}{(2\pi\sigma^2/n)^{-\frac{1}{2}}\Exp{[-\frac{n(\exv{x}-\mu)^2}{2\sigma^2}]}}\\
	&=
	\end{align*}
