...
\begin{wordonframe}{Esempio importanza ensamble (selection bias)}
	...
	\begin{columns}[T]
		...
		\end{column}
	\end{columns}
	Tempo medio di attesa in quale ensamble?
	\begin{columns}[T]
		\begin{column}{0.55\textwidth}
			...
			Soluzione: distro uniforme sul numero di autobus (il quinto ...)/SR autista: quelli con tempi caratteristici pi\'u lunghi raccolgono pi\'u passeggeri.\mykeyword{Ex: distro tempi da autobus blu}
		\end{column}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth,keepaspectratio]{RVfunc}
	\label{fig:RVfunc}
\end{figure}
\begin{align*}
