...
\begin{itemize}
	...
	\begin{align*}
	&\underbrace{g(Y_1,\ldots,Y_n;\theta)}_{\prod_if(w_i(\iidrv{N}{Y});\theta)}=|J|g_1(Y_1;\theta)H(w_1(Y_1,\ldots,Y_n),\ldots,w_n(Y_1,\ldots,Y_n))
	\end{align*}
	$g_1$ is pdf of $Y_1$ so $|J|H(\ldots)=\frac{g}{g_1}$ which is conditional pdf $h(Y_2,\ldots,Y_N|Y_1;\theta)$ of $Y_2,\ldots,Y_N$ given $Y_1=y_1$. $H(\iidrv{})$ and $H(\iidrv{N}{W})$ don't dep. on $\theta$, quindi $h(Y_2,\ldots,Y_N|Y_1;\theta)$ don't deps on $\theta$ e $Y_1$ \'e stat. suff. per $\theta$.
