...
\begin{wordonframe}{Pearson $\chi^2$ statistic}
\begin{align*}
&Q_n=\sum_j^{k+1}\frac{(Y_j-n\pi_j)^2}{n\pi_j}\xrightarrow{n\to\infty}\chi^2(k)
\end{align*}
If $c_{k,1-\alpha}$ is the $1-\alpha$ quantile of $\chi^2_k$ then test that rejects when $Q_n>c_{k,1-\alpha}$ is asymptotically level $\alpha$.
\end{wordonframe}
