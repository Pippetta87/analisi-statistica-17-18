...
\begin{wordonframe}{Modello di partita di calcio - Compito del $10/09/19$}
...
\begin{wordonframe}{Contaminazione radioattiva - Compito del $10/09/19$}
$^{32}P$, $t_{1/2}^{32}=\SI{14.263}{\day}$ di cui voglio misurare livello contaminazione con isotopo raro $^{33}P$, $t_{1/2}^{33}=\SI{25.25}{\day}$. Misuro conteggi particelle beta con rivelatore a stessa ora del giorno per 5 giorni $\{n_1,\ldots,n_5\}$.
