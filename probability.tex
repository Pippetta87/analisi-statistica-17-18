...
\end{align*}
\item Per Paul-L\'evy $Y_n$ \'e asintoticamente normale
\end{itemize}
\end{frame}
...
Siano $\iidrv$ con $\E{[X_i]}=0$, $\E{[X_i]}=\sigma^2$, $\E{|X_i|^3}=a\leq\infty$ e $Y_N=\frac{\iidrv[X][+][1][N]}{N}$
\end{block}
\begin{block}{}
...
\begin{frame}{\todo{De Moivre–Laplace theorem}}
