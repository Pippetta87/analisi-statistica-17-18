...
%\end{block}
	...
	Se $H_0$ impone r vincoli sugli $r+s$ parametri di $H_0$, $H_1$:
\begin{align*}
&\forall\theta\in H_0:\ -2\log{\lambda}\to\chi^2_{r}\\
&\forall\theta\in H_1:\ -2\log{\lambda}\to\chi^2_{NC,r}\tag{non centrale}\\
